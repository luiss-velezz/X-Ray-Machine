...
- a connector of an electrical component is not connected.");
  annotation(
    ...
    Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(fillColor = {73, 151, 60}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}})}),
    Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {73, 151, 60}, fillPattern = FillPattern.Solid, extent = {{-40, 40}, {40, -40}}), Text(textColor = {0, 0, 255}, extent = {{-160, 110}, {40, 50}}, textString = "%name")}),
